...
| Выбор тарифа.      | Исходя из анализа поведения клиентов сделать вывод какой тариф приносит больше денег компании для планирования рекламного бюджета.        |   $12 |
| Определение возраста. | are neat        |    $1 |
| Определение стоимости автомобиля. | are neat        |    $1 |
| Отток клиентов из банка.      | centered        |   $12 |
| Поиск токсичных комментариев. | are neat        |    $1 |
| Предсказание скважины.      | centered        |   $12 |
| Прогнозирование заказов такси. | are neat        |    $1 |
| Продажа квартир.      | centered        |   $12 |
| Продажа компьютерных игр. | are neat        |    $1 |
| Рекомендация тарифа.      | centered        |   $12 |
| Скоринговая модель. | are neat        |    $1 |
| Спрос на рейсы авиакомпании.      | centered        |   $12 |
